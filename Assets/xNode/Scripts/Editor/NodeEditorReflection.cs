...
namespace XNodeEditor {
    ...
    public static class NodeEditorReflection {
        ...
        public static bool TryGetAttributeTitle(this Type nodeType, out string text) {
            if (nodeTitle == null) {
                CacheAttributes<string, XNode.Node.NodeTitleAttribute>(ref nodeTitle, x => x.text);
            }
            return nodeTitle.TryGetValue(nodeType, out text);
        }
