...
namespace XNodeEditor
{
    ...
    public partial class NodeEditorWindow : EditorWindow
    {
...
#if ODIN_INSPECTOR
            Undo.undoRedoPerformed -= ClearOdin;
#endif
        }
        ...
        public static NodeEditorWindow Init()
        {
            ...
            w.titleContent = new GUIContent("xNode1");
        ...
        public static NodeEditorWindow Open(XNode.NodeGraph graph)
        {
            ...
            NodeEditorWindow w = GetWindow(typeof(NodeEditorWindow), false, "sequence", true) as NodeEditorWindow;
            w.wantsMouseMove = true;
            w.graph = graph;
            return w;
        }
