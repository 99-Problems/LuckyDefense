...
public class StringManager : MonoBehaviour
{
    ...
    static async UniTask LoadStringInfoScript()
    {
        ...
        var korean = await Managers.Resource.LoadJsonByLabel("stringKorean");
        {
    ...
    {
        var font = await GetFontKorean(_fontType);
        return font;
    }

    public static async UniTask<TMP_FontAsset> GetFontKorean(Define.EFONT_TYPE _fontType)
    {
        ...
        switch (_fontType)
        {
            ...
            case Define.EFONT_TYPE.Default:
                font = await Managers.Resource.LoadAsyncFont("ui/font", "NanumBarunGothicSDF");
    ...
    {
        return await GetMaterialKorean(_fontType);
    }

    public static async UniTask<Material> GetMaterialKorean(Define.EFONT_TYPE _fontType)
    {
        ...
        switch (_fontType)
        {
            case Define.EFONT_TYPE.ENONE:
            case Define.EFONT_TYPE.Default:
                material = await Managers.Resource.LoadAsyncMaterial("ui/material", "NanumBarunGothicSDF_Default");
