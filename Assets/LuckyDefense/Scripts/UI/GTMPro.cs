...
public partial class GTMPro : MonoBehaviour
{
    ...
    public void SetEditString()
    {
        ...
        
        {
            ...
            {
                default:
                    fontKey = "NanumBarunGothicSDF.asset";
                    matKey = $"{text.fontSharedMaterial.name}.mat";
                    break;
            }
            var font_assetPath = String.Concat("Assets/LuckyDefense/ui/font/", fontKey);
            ...
            var mat_assetPath = String.Concat("Assets/LuckyDefense/ui/font/", matKey);
    ...
    {
        string path = "Assets/LuckyDefense/Prefabs/scripts/string/stringKorean.json";
